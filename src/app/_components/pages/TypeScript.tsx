...
export default function TypeScript() {
    return (
        <CardRapper>
            ...
            <span className="text-blue-500">TypeScript</span> is a <span className="text-purple-500">typed superset</span> of JavaScript that brings static typing to the language. It helps catch errors early and makes code easier to maintain.<br />
